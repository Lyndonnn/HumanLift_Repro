...
def render1(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, separate_sh = False, override_color = None, use_trained_exp=False, orthographic=False):
    """
    Render the scene. 
...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, separate_sh = False, override_color = None, use_trained_exp=False, orthographic=False):
    """
    Render the scene. 
    ...
    render_colors, render_alphas, info = rasterization(
        ...
        packed=False,
        sh_degree=sh_degree,
        camera_model="ortho" if orthographic else "pinhole",
        render_mode="RGB+ED",
